...
### 사용자/고객 여정 (User Journey) ⚠️ 필수!
⚠️ **이 섹션은 절대 생략 불가!** 모든 기획서에 반드시 포함해야 함.

1. **[인지/유입]**: [유입 경로] (예: SNS 광고, 지인 추천, 검색)
2. **[탐색/가입]**: [첫 접점 후 행동] (예: 앱 설치, 회원가입)
3. **[핵심 기능 사용]**: [메인 기능 체험] (예: 상품 검색, 콘텐츠 소비)
4. **[전환/결제]**: [구매/구독 결정] (예: 장바구니 담기, 결제)
5. **[재방문/추천]**: [재사용 유도] (예: 푸시 알림, 리뷰 작성, 친구 추천)

✅ 예시 (오프라인 매장):
"1. 인지: SNS 인플루언서 추천으로 매장 인지
2. 방문: 주말에 친구와 함께 매장 방문
3. 체험: 맞춤 상담 후 제품 테스트
4. 구매: 기프트 패키지 구매
5. 재방문: 시즌 신제품 출시 시 알림 수신 후 재방문"

### 시장 규모 (⚠️ TAM/SAM 정합성 + 단위 통일!)
⚠️ **통화 단위 규칙**:
   - 글로벌 시장 → **달러** (예: $50B)
   - 국내 시장 → **원** (예: 5조 원)
